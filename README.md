...
5. If the MediaPipe component shows a missing external tox warning:
   ...
   - Enable **External .tox**
   - Point the path to `toxes/MediaPipe.tox`
...
- This is a beginner-level project created while learning TouchDesigner.
- The visual style was inspired by Instagram reels on the song “I Hope You Find Some Peace of Mind”.
